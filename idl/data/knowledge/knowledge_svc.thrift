...
service DatasetService {
    ...
    document.RetryDocumentResponse RetryDocument(1:document.RetryDocumentRequest req) (api.post='/api/knowledge/document/retry', api.category="knowledge",agw.preserve_base="true")
